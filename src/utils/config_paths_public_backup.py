...
For public use, set the following environment variables:
- OCO3_DATA_DIR: Directory containing OCO-3 Lite files
- OCO3_OUTPUT_DIR: Directory for processed output files (optional)
...
class PathConfig:
    ...
    def __init__(self, project_root=None):
        ...
        self.EXPERIMENT_NAME = "Swath_BC_" + self.MODEL_VERSION + "_FinalHardcoded"
        ...
        # OCO-3 Lite files (input data) - Use environment variable or default
        self.LITE_FILES_DIR = os.getenv('OCO3_DATA_DIR', 
                                       str(self.project_root / "data" / "input"))
        ...
        # Output processed files - Use environment variable or default to project directory
        self.OUTPUT_BASE_DIR = os.getenv('OCO3_OUTPUT_DIR', 
    ...
    def print_config_summary(self):
        ...
        oco3_data_dir = os.getenv('OCO3_DATA_DIR')
        oco3_output_dir = os.getenv('OCO3_OUTPUT_DIR')
        
        if oco3_data_dir:
            print(f"✅ OCO3_DATA_DIR: {oco3_data_dir}")
        else:
            print(f"⚠️  OCO3_DATA_DIR not set, using default: {self.LITE_FILES_DIR}")
            
        if oco3_output_dir:
            print(f"✅ OCO3_OUTPUT_DIR: {oco3_output_dir}")
        else:
            print(f"⚠️  OCO3_OUTPUT_DIR not set, using default: {self.OUTPUT_BASE_DIR}")
        print("="*60)
